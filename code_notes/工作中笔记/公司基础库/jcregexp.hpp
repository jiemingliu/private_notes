/******************************************************************************
* 文件名: jcregexp.hpp
* 描述: 正则表达式类型, 使用RegExlab的开源实现
* 
*
* 修改记录:
* --------------------
* v1.0   2014/03/14 10:37:56, lys 创建文件
*
******************************************************************************/
...
// Regexp
typedef CRegexpT <char> JCRegexpA;
typedef CRegexpT <unsigned short> JCRegexpW;

#if defined(_UNICODE) || defined(UNICODE)
	typedef JCRegexpW JCRegexp;
#else
	typedef JCRegexpA JCRegexp;
#endif
