...
* 修改记录:
* --------------------
* v1.0   2016/02/27 14:11:31, lys 创建文件, 引用自ExcelFormat库, 鉴于已经比较精简
* , 只是进行简单的类名修改以及类导出, 以适应JCBase的统一规范
******************************************************************************/
...
#ifndef _JCBASICEXCEL_H_
#define _JCBASICEXCEL_H_
...
struct DLL_EXPORT CompoundFile
{
	CompoundFile();
	~CompoundFile();
...
struct DLL_EXPORT BOF : public Record
{
	BOF();
	virtual ULONG Read(const char* data);
	virtual ULONG Write(char* data);
...
public:
	...
	struct DLL_EXPORT Window1 : public Record
	{
		Window1();
		virtual ULONG Read(const char* data);
		virtual ULONG Write(char* data);
	...
	struct RefreshAll;
	struct BookBool;
	struct DLL_EXPORT Font : public Record
	{
		Font();
		virtual ULONG Read(const char* data);
		virtual ULONG Write(char* data);
	...
	struct DLL_EXPORT Format : public Record
	{
		//MF
		Format();
	...
	struct DLL_EXPORT XF : public Record
	{
		XF();
		virtual ULONG Read(const char* data);
		virtual ULONG Write(char* data);
	...
	struct DLL_EXPORT Style : public Record
	{
		Style();
		virtual ULONG Read(const char* data);
		virtual ULONG Write(char* data);
	...
	struct Palette;
	struct UseSelfs;
	struct DLL_EXPORT BoundSheet : public Record
	{
		BoundSheet();
		virtual ULONG Read(const char* data);
		virtual ULONG Write(char* data);
	...
	struct Country;
	struct LinkTable;
	struct DLL_EXPORT SharedStringTable : public Record
	{
		SharedStringTable();
		virtual ULONG Read(const char* data);
		virtual ULONG Write(char* data);
	...
	struct DLL_EXPORT ExtSST : public Record
	{
		ExtSST();
		virtual ULONG Read(const char* data);
		virtual ULONG Write(char* data);
...
public:
	struct Uncalced;
	struct DLL_EXPORT Index : public Record
	{
		Index();
		virtual ULONG Read(const char* data);
		virtual ULONG Write(char* data);
	...
	struct DLL_EXPORT CalculationSettings
	{
		struct CalcCount;
		struct CalcMode;
		struct RefMode;
	...
	struct WSBool;
	struct DLL_EXPORT PageSettings
	{
		struct Header;
		struct Footer;
		struct HCenter;
	...
	struct DefColWidth;
	struct DLL_EXPORT ColInfo : public Record
	{
		ColInfo();
		virtual ULONG Read(const char* data);
		virtual ULONG Write(char* data);
	...
	struct Sort;
	struct DLL_EXPORT ColInfos : public Record
	{
		virtual ULONG Read(const char* data);
		virtual ULONG Write(char* data);
		virtual ULONG RecordSize();
	...
	struct DLL_EXPORT Dimensions : public Record
	{
		Dimensions();
		virtual ULONG Read(const char* data);
		virtual ULONG Write(char* data);
	...
	struct DLL_EXPORT CellTable
	{
		struct DLL_EXPORT RowBlock
		{
			struct DLL_EXPORT Row : public Record
			{
				Row();
				virtual ULONG Read(const char* data);
				virtual ULONG Write(char* data);
			...
			struct DLL_EXPORT CellBlock : public RefCnt
			{
				struct DLL_EXPORT Blank : public Record
				{
					Blank();
					virtual ULONG Read(const char* data);
					virtual ULONG Write(char* data);
				...
				struct DLL_EXPORT BoolErr : public Record
				{
					BoolErr();
					virtual ULONG Read(const char* data);
					virtual ULONG Write(char* data);
				...
				struct DLL_EXPORT LabelSST : public Record
				{
					LabelSST();
					virtual ULONG Read(const char* data);
					virtual ULONG Write(char* data);
				...
				struct DLL_EXPORT MulBlank : public Record
				{
					MulBlank();
					virtual ULONG Read(const char* data);
					virtual ULONG Write(char* data);
				...
				struct DLL_EXPORT MulRK : public Record
				{
					MulRK();
					virtual ULONG Read(const char* data);
					virtual ULONG Write(char* data);
				...
				struct DLL_EXPORT Number : public Record
				{
					Number();
					virtual ULONG Read(const char* data);
					virtual ULONG Write(char* data);
				...
				struct DLL_EXPORT RK : public Record
				{
					RK();
					virtual ULONG Read(const char* data);
					virtual ULONG Write(char* data);
				...
				struct DLL_EXPORT Formula : public Record
				{
					struct DLL_EXPORT Array : public Record
					{
						Array();
						virtual ULONG Read(const char* data);
						virtual ULONG Write(char* data);
					...
					struct DLL_EXPORT ShrFmla : public Record
					{
						ShrFmla();
						virtual ULONG Read(const char* data);
						virtual ULONG Write(char* data);
					...
					struct DLL_EXPORT ShrFmla1 : public Record
					{
						ShrFmla1();
						virtual ULONG Read(const char* data);
						virtual ULONG Write(char* data);
					...
					struct DLL_EXPORT Table : public Record
					{
						Table();
						virtual ULONG Read(const char* data);
						virtual ULONG Write(char* data);
					...
					struct DLL_EXPORT String : public Record
					{
						String();
						~String();
						virtual ULONG Read(const char* data);
			...
			struct DLL_EXPORT DBCell : public Record
			{
				DBCell();
				virtual ULONG Read(const char* data);
				virtual ULONG Write(char* data);
	...
	struct DLL_EXPORT Window2 : public Record
	{
		Window2();
		virtual ULONG Read(const char* data);
		virtual ULONG Write(char* data);
	...
	struct Pane;
	struct Selection;
	struct DLL_EXPORT MergedCells
	{
		struct DLL_EXPORT MergedCell
		{
			MergedCell();
			virtual ULONG Read(const char* data);
			virtual ULONG Write(char* data);
...
class JCBasicExcel;
class JCBasicExcelWorksheet;
class JCBasicExcelCell;

/*******************************************************************************************************/
/*						   Actual classes to read and write to Excel files							   */
/*******************************************************************************************************/
class DLL_EXPORT JCBasicExcel
{
public:
	JCBasicExcel();
	JCBasicExcel(const char* filename);
	~JCBasicExcel();
...
public: // Worksheet functions.
	...
	JCBasicExcelWorksheet* GetWorksheet(int sheetIndex);	///< Get a pointer to an Excel worksheet at the given index. Index starts from 0. Returns 0 if index is invalid.
	JCBasicExcelWorksheet* GetWorksheet(const char* name);	///< Get a pointer to an Excel worksheet that has given ANSI name. Returns 0 if there is no Excel worksheet with the given name.
	JCBasicExcelWorksheet* GetWorksheet(const wchar_t* name); ///< Get a pointer to an Excel worksheet that has given Unicode name. Returns 0 if there is no Excel worksheet with the given name.

	JCBasicExcelWorksheet* AddWorksheet(int sheetIndex=-1);	///< Add a new Excel worksheet to the given index. Name given to worksheet is SheetX, where X is a number which starts from 1. Index starts from 0. Worksheet is added to the last position if sheetIndex == -1. Returns a pointer to the worksheet if successful, 0 if otherwise.
	JCBasicExcelWorksheet* AddWorksheet(const char* name, int sheetIndex=-1); ///< Add a new Excel worksheet with given ANSI name to the given index. Index starts from 0. Worksheet is added to the last position if sheetIndex == -1. Returns a pointer to the worksheet if successful, 0 if otherwise.
	JCBasicExcelWorksheet* AddWorksheet(const wchar_t* name, int sheetIndex=-1);	///< Add a new Excel worksheet with given Unicode name to the given index. Index starts from 0. Worksheet is added to the last position if sheetIndex == -1. Returns a pointer to the worksheet if successful, 0 if otherwise.
...
public:
	...
	vector<SmartPtr<JCBasicExcelWorksheet> > yesheets_;	///< Parsed Worksheets.
};

class DLL_EXPORT JCBasicExcelWorksheet : public RefCnt
{
	friend class JCBasicExcel;

public:
	JCBasicExcelWorksheet(JCBasicExcel* excel, int sheetIndex);
...
public: // Cell functions
	...
	JCBasicExcelCell* Cell(int row, int col); ///< Return a pointer to an Excel cell. row and col starts from 0. Returns 0 if row exceeds 65535 or col exceeds 255.
	const JCBasicExcelCell* Cell(int row, int col) const; ///< Return a pointer to an Excel cell. row and col starts from 0. Returns 0 if row exceeds 65535 or col exceeds 255.
...
private: // Internal functions
	void UpdateCells(); ///< Update cells using information from JCBasicExcel.worksheets_.

private:
	JCBasicExcel* excel_; 				///< Pointer to instance of BasicExcel.
	...
	vector<vector<JCBasicExcelCell> > cells_; ///< Cells matrix.
	Worksheet::ColInfos colInfos_;		/// used to record column info
};

class DLL_EXPORT JCBasicExcelCell
{
public:
	JCBasicExcelCell();
	...
	friend ostream& operator<<(ostream& os, const JCBasicExcelCell& cell);	///< Print cell to output stream. Print a null character if cell is undefined.
	...
	void SetFormat(const CellFormat& fmt); //MF
...
private:
	...
	friend class JCBasicExcel;
	friend class JCBasicExcelWorksheet; // for Get(w/char*);

	struct Formula : public RefCnt
	{
